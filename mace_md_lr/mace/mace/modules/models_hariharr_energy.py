...
@compile_mode("script")
class TestMACE(torch.nn.Module):
    def __init__(
        self,
        r_max: float,
        num_bessel: int,
    ...
    def forward(
        ...
        for enum_ind, (interaction, product, readout) in enumerate(zip(
            ...
            print(node_feats.shape, self.slice_indices[enum_ind], node_feats[:, :self.slice_indices[enum_ind]].shape)            
            # node_feat_ewald = ewald_block(node_feats[:self.slice_indices[enum_ind]])
            ...
            # node_feat[:self.slice_indices[enum_ind]] += node_feat_ewald            
            print("node_feats inside interaction:", node_feats.shape)            
